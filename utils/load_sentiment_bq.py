# utility script for uploading sentiment files from Storage to BigQuery
...
dataset_id = cfg["bigquery"]["sentiment dataset id"]
table_id = cfg["bigquery"]["sentiment table id"]
...
source_bucket_name = cfg["storage"]["sentiment staging"]
destination_bucket_name = cfg["storage"]["sentiment processed"]
